...
START_TEST(decimal_test_mul_9) {
  ...
  s21_decimal num2 = {{25, 0, 73, 0x80050000}};
  s21_decimal num3 = {{0}};
  int error = s21_mul(num1, num2, &num3);
...
START_TEST(decimal_test_mul_17) {
  ...
  s21_decimal num3 = {{0}};
  int error = s21_mul(num1, num2, &num3);
  ck_assert_msg(error == 1, "s21_add_1 failed");
}
END_TEST
...
START_TEST(decimal_test_mul_18) {
  ...
  s21_decimal num3 = {{0}};
  int error = s21_mul(num1, num2, &num3);
  ck_assert_msg(error == 2, "s21_add_1 failed");
}
END_TEST
...
START_TEST(decimal_test_mul_24) {
  s21_decimal num1 = {{0x88000001, 0x1F128130, 0x1027E72F, 0x1C0000}};
