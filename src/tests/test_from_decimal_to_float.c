...
START_TEST(test_1) {
  ...
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
...
END_TEST
START_TEST(test_4) {
  s21_decimal num1 = {{0, 0, 0, 0x80000000}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
  ck_assert_float_eq(num2, -0.000000);
  ck_assert_int_eq(error_code, 0);
...
END_TEST
START_TEST(test_5) {
  s21_decimal num1 = {{0b111010110111100110100010101, 0, 0, 0x00030000}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
...
END_TEST
START_TEST(test_6) {
  s21_decimal num1 = {{199999, 0, 0, 0x80050000}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
...
END_TEST
START_TEST(test_7) {
  s21_decimal num1 = {{199999, 0, 0, 0x00140000}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
...
END_TEST
START_TEST(test_8) {
  s21_decimal num1 = {{0b111010110111100110100010101,
...
START_TEST(test_10) {
  s21_decimal num1 = {{123123123, 0, 0, 0x80060000}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
...
END_TEST
START_TEST(test_11) {
  s21_decimal num1 = {{1, 1, 1, 0x00090000}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
...
END_TEST
START_TEST(test_12) {
  s21_decimal num1 = {{0b11111111111111111111111111111111, 0, 0, 0x80000000}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
...
START_TEST(test_13) {  // Scale overflow
  s21_decimal num1 = {{1, 1, 1, 0x001E0000}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
...
END_TEST
START_TEST(test_14) {
  s21_decimal num1 = {{0b11111111111111111111111111111111, 0, 0, 0x80010001}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, &num2);
  ck_assert_float_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
START_TEST(test_15) {
  s21_decimal num1 = {{1000, 0, 0, 0x80010000}};
  float num2 = 0;
  int error_code = s21_from_decimal_to_float(num1, NULL);
  ck_assert_float_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
}
END_TEST
