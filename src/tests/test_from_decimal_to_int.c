...
START_TEST(test_1) {
  ...
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
...
END_TEST
START_TEST(test_4) {
  s21_decimal num1 = {{INT32_MAX, INT32_MAX, INT32_MAX, 0x00000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
...
END_TEST
START_TEST(test_5) {
  s21_decimal num1 = {{0, 10, 0, 0x00120000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 0);
...
END_TEST
START_TEST(test_6) {
  s21_decimal num1 = {{0, 10, 0, 0x80120000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 0);
...
END_TEST
START_TEST(test_7) {
  s21_decimal num1 = {{0, 1, 0, 0x80050000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
...
END_TEST
START_TEST(test_8) {
  s21_decimal num1 = {{2147483648, 0, 0, 0x00000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
END_TEST
START_TEST(test_9) {
  s21_decimal num1 = {{2147483648, 0, 0, 0x80000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
...
END_TEST
START_TEST(test_10) {
  s21_decimal num1 = {{101, 0, 0, 0x0020000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
...
END_TEST
START_TEST(test_11) {
  s21_decimal num1 = {{0b111010110111100110100010101, 0, 0, 0x00020000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
...
START_TEST(test_12) {
  s21_decimal num1 = {{0b111010110111100110100010101, 0, 0, 0x00020001}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
END_TEST
START_TEST(test_13) {
  s21_decimal num1 = {{0, 0, 10, 0x001c0000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 0);
...
END_TEST
START_TEST(test_14) {
  s21_decimal num1 = {{0, 0, 100, 0x801c0000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 0);
...
END_TEST
START_TEST(test_16) {
  s21_decimal num1 = {{0, INT32_MAX, INT32_MAX, 0x001f0000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
END_TEST
START_TEST(test_17) {
  s21_decimal num1 = {{1, 10, 1, 0x000f0000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
...
END_TEST
START_TEST(test_18) {
  s21_decimal num1 = {{1, 0, 0, 0x81030000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
END_TEST
START_TEST(test_19) {
  s21_decimal num1 = {{1, 0, 0, 0x88050000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
END_TEST
START_TEST(test_20) {
  s21_decimal num1 = {{0, 0, 0, 0x00000001}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
END_TEST
START_TEST(test_21) {
  s21_decimal num1 = {{0, 0, 0, 0x01000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
END_TEST
START_TEST(test_22) {
  s21_decimal num1 = {{1999999999, 0, 0, 0x0000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
...
END_TEST
START_TEST(test_23) {
  s21_decimal num1 = {{UINT32_MAX, 0, 0, 0x00020000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
...
START_TEST(test_24) {
  s21_decimal num1 = {{0b111010110111100110100010101, 0, 0, 0x84000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
END_TEST
START_TEST(test_25) {
  s21_decimal num1 = {{0x80000000, 0x0, 0x0, 0x80000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, -2147483648);
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_27) {
  s21_decimal num1 = {{0x0, 0x32, 0x0, 0x80020000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, -2147483648);
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_28) {
  s21_decimal num1 = {{0x63, 0x32, 0x0, 0x80020000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, -2147483648);
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_29) {
  s21_decimal num1 = {{0xA763FFFF, 0xE192B6B3, 0x6F05B59, 0x80120000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, -2147483648);
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_30) {
  s21_decimal num1 = {{0xA763FFFF, 0xE192B6B3, 0x6F05B59, 0x80120000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, NULL);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
}
START_TEST(test_31) {
  s21_decimal num1 = {{1, UINT32_MAX, 0, 0x00000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
START_TEST(test_32) {
  s21_decimal num1 = {{1, 0, UINT32_MAX, 0x00000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
START_TEST(test_33) {
  s21_decimal num1 = {{4294967295, 4294967295, 429496729, 0x00020000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
...
START_TEST(test_34) {
  s21_decimal num1 = {{4294967295, 0, 0, 0x80000000}};
  int num2 = 0;
  int error_code = s21_from_decimal_to_int(num1, &num2);
  ck_assert_int_eq(num2, 0);
  ck_assert_int_eq(error_code, 1);
