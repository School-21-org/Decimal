...
START_TEST(test_1) {
  ...
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
...
START_TEST(test_2) {
  int num1 = -10;
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{10, 0, 0, 0x80000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_4) {
  int num1 = 2147483647;
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {
      {0b1111111111111111111111111111111, 0, 0, 0x00000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_5) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {
      {0b1111111111111111111111111111111, 0, 0, 0x80000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_7) {
  int num1 = 10000;
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{10000, 0, 0, 0x00000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_8) {
  ...
  s21_decimal test_num = {{10000, 0, 0, 0x80000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_9) {
  int num1 = 123456789;
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{123456789, 0, 0, 0x00000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_10) {
  int num1 = -1999999;
  s21_decimal num2 = {{0, 0, 0, 0x80000000}};
  s21_decimal test_num = {{1999999, 0, 0, 0x80000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_11) {
  int num1 = 111111111;
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{111111111, 0, 0, 0x00000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_12) {
  int num1 = -111111111;
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{111111111, 0, 0, 0x80000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_13) {
  int num1 = 100500;
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{100500, 0, 0, 0x00000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_16) {
  int num1 = -800;
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{800, 0, 0, 0x80000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_17) {
  int num1 = 10101;
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{10101, 0, 0, 0x00000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_18) {
  int num1 = -10001;
  s21_decimal num2 = {{0, 0, 0, 0x80000000}};
  s21_decimal test_num = {{10001, 0, 0, 0x80000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_19) {
  int num1 = 2586461;
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{2586461, 0, 0, 0x00000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_20) {
  int num1 = -70000;
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{70000, 0, 0, 0x80000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_21) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{2147483648, 0, 0, 0x80000000}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1,
                "decimal written incorrectly");
  ck_assert_int_eq(error_code, 0);
...
START_TEST(test_22) {
  int num1 = INT32_MAX;
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{2147483647, 0, 0, 0}};
  int error_code = s21_from_int_to_decimal(num1, &num2);
...
START_TEST(test_23) {
  int num1 = 123;
  int error_code = s21_from_int_to_decimal(num1, NULL);
