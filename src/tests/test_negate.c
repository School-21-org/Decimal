...
START_TEST(test_1) {
  s21_decimal num1 = {{12345, 0, 0, 0x00030000}};
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{12345, 0, 0, 0x80030000}};
  int error_code = s21_negate(num1, &num2);
...
START_TEST(test_2) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{54321, 0, 0, 0x00040000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_3) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{1, 0, 0, 0x801c0000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_5) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0xffffffff, 0xffffffff, 0xffffffff, 0x001c0000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_6) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0xfffffffe, 0xfffffffe, 0xfffffffe, 0x801c0000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_7) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{1, 1, 1, 0x00020000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
END_TEST
START_TEST(test_8) {
  s21_decimal num1 = {{0b111010110111111000000111101, 0, 0, 0x80050000}};
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{0b111010110111111000000111101, 0, 0, 0x00050000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_9) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{1, 1, 0, 0x00020000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_10) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{19999, 0, 0, 0x80020000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_11) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{123, 123, 123, 0x80030000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_12) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{123456789, 0, 0, 0x00060000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_13) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0xFFFFFFFF, 0, 0, 0x80070000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_14) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0xFFFFFFFF, 0xFFFFFFFF, 0, 0x000f0000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_15) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0xffffffff, 0xffffffff, 0xffffffff, 0x80100000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_16) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0b11111111111111111111111111111111,
                           0b11111111111111111111111111111111,
...
START_TEST(test_18) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{21, 31, 41, 0x00090000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
END_TEST
START_TEST(test_19) {
  s21_decimal num1 = {{11112222, 0, 0, 0x00070000}};
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{11112222, 0, 0, 0x80070000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_20) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{0, 1, 0, 0x80020000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
END_TEST
START_TEST(test_21) {
  s21_decimal num1 = {{1000000, 0, 0, 0x00060000}};
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{1000000, 0, 0, 0x80060000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_22) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{1234565, 0, 0, 0x00040000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_23) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{999999, 0, 0, 0x801c0000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_24) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{100, 100, 1000, 0x800f0000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_25) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0xffffffff, 0, 0xffffffff, 0x001a0000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_26) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0xfffffffe, 0xfffffffe, 0xfffffffe, 0x80140000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_27) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{1, 1, 0xfffffffe, 0x00020000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
END_TEST
START_TEST(test_28) {
  s21_decimal num1 = {{0b111010110111111000000111101, 0, 0, 0x80090000}};
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{0b111010110111111000000111101, 0, 0, 0x00090000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_29) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{1, 0, 1, 0x00040000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
...
START_TEST(test_30) {
  ...
  s21_decimal num2 = {{0, 0, 0, 0x00000000}};
  s21_decimal test_num = {{12983476, 0, 0, 0x80070000}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
  ck_assert_int_eq(error_code, 0);
}
END_TEST
START_TEST(test_31) {
  s21_decimal num1 = {{1, 0, 0, 0x001E0000}};
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0, 0, 0, 0}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
...
END_TEST
START_TEST(test_32) {
  s21_decimal num1 = {{12983476, 0, 0, 0x01000001}};
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0, 0, 0, 0}};
  int error_code = s21_negate(num1, &num2);
  ck_assert_msg(s21_is_equal(num2, test_num) == 1, "s21_is_equal failed");
...
END_TEST
START_TEST(test_33) {
  s21_decimal num1 = {{12983476, 0, 0, 0x00000000}};
  s21_decimal num2 = {{0, 0, 0, 0}};
  s21_decimal test_num = {{0, 0, 0, 0}};
